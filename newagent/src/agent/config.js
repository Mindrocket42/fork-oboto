...
export const MAX_CONTEXT_TURNS = 10; // Dynamic Context Window limit
...
[INVOLUNTARY ASSOCIATIVE RECALL]
The following memories were automatically triggered by your current context:
${autoRecall || "(No highly relevant involuntary memories triggered.)"}
...
- mem_search [query] : Search voluntary long-term memory
